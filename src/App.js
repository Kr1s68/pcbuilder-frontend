...
function App() {
  ...
  function sendApiCall() {
    const apiUrl = "https://pcbuilder-api.onrender.com/api/data/Cases";
  ...
  setInterval(sendApiCall, interval);
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route
            path="/builder"
            element={<Builder isLoaded={isLoaded} loadedBuild={currentBuild} />}
          />
          ...
          <Route
            path="/mybuilds"
            element={<MyBuilds loadSavedBuild={loadSavedBuild} />}
          />
