...
function AddMotherbards(props) {
    ...
    const addItem = () => {
        ...
        Axios.post(`https://pc-builder-api.herokuapp.com/api/data/createMotherboard`,{ 
    ...
    return (
        <div style={{paddingBlock:"90px", display:displayable}}>
            <div>
                ...
                <CustomInput Heading = "Chipset: " Type = "text" onChange = {handleChange} name = "Chipset"/>
                <CustomInput Heading = "Memory: " Type = "text" onChange = {handleChange} name = "Memory"/>
                <CustomInput Heading = "Form Factor: " Type = "text" onChange = {handleChange} name = "FormFactor" />
