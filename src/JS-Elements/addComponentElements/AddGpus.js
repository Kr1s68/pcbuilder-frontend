...
/*
    ...
    const addItem = () => {
        ...
        Axios.post(`https://pc-builder-api.herokuapp.com/api/data/createGpu`,{ 

            Model:formData.Model,
            Memory:formData.Memory, 
            CoreFrequency:formData.CoreFrequency,
            BoostCoreFrequency:formData.BoostCoreFrequency,
    ...
    return (
        <div style={{paddingBlock:"90px", display:displayable}}>
            <div>
                ...
                <CustomInput Heading = "Memory: " Type = "text" onChange = {handleChange} name = "Memory"/>
                <CustomInput Heading = "Core Frequency: " Type = "text" onChange = {handleChange} name = "CoreFrequency" />
                <CustomInput Heading = "Boost Core Frequency: " Type = "text" onChange = {handleChange} name = "BoostCoreFrequency"/>
                <CustomInput Heading = "Interface: " Type = "text" onChange = {handleChange} name = "Interface" />
                <CustomInput Heading = "TDP: " Type = "text" onChange = {handleChange} name = "TDP" />
