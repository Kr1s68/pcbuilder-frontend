...
/*
    ...
    const addItem = () => {
        ...
        Axios.post(`https://pc-builder-api.herokuapp.com/api/data/createCpu`,{ 
            ...
            NodeProcess:formData.NodeProcess,
    ...
    return (
        <div style={{paddingBlock:"90px", display:displayable}}>
            <div>
                ...
                <CustomInput Heading = "Socket: " Type = "comboBox" onChange = {handleChange} name = "Socket" />
                <CustomInput Heading = "Core Count: " Type = "number" onChange = {handleChange} name = "CoreCount"/>
                <CustomInput Heading = "Thread Count: " Type = "number" onChange = {handleChange} name = "ThreadCount"/>
                <CustomInput Heading = "Core Frequency: " Type = "text" onChange = {handleChange} name = "CoreFrequency" />
                <CustomInput Heading = "Node Process: " Type = "text" onChange = {handleChange} name = "NodeProcess"/>
...
function CustomInput(props){
    ...
    return (
        ...
        <div style={{display:"flex", flexDirection:'column', alignItems:'center'}}>
            ...
            <>
                <label style={{fontSize:'24px', color:' rgb(231, 227, 231)', marginLeft: '-90px'}}>Socket</label>
